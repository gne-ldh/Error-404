...
('vl07frslq5bklalbis29u2to1e', 8, 'JavaScript is ______ Side Scripting Language.', 'Browser', 'Client', 'Server', 'Both B and C', 4, 4),
('vl07frslq5bklalbis29u2to1e', 8, 'The script tag must be placed in?', 'Head', 'Head and body', 'Title and head', 'Head and Title', 2, 4),
('002h2momagsi5h27drqt43rlq3', 8, 'Javascript is _________ language.', 'Scripting', 'Programming', 'Application', 'All of these', 1, 1),
('002h2momagsi5h27drqt43rlq3', 8, 'JavaScript is ______ Side Scripting Language.', 'Browser', 'Client', 'Server', 'Both B and C', 4, 4),
('002h2momagsi5h27drqt43rlq3', 8, 'The script tag must be placed in?', 'Head', 'Head and body', 'Title and head', 'Head and Title', 2, 4),
('002h2momagsi5h27drqt43rlq3', 8, 'Javascript is _________ language.', 'Scripting', 'Programming', 'Application', 'All of these', 1, 1),
('002h2momagsi5h27drqt43rlq3', 8, 'JavaScript is ______ Side Scripting Language.', 'Browser', 'Client', 'Server', 'Both B and C', 4, 4),
('002h2momagsi5h27drqt43rlq3', 8, 'The script tag must be placed in?', 'Head', 'Head and body', 'Title and head', 'Head and Title', 2, 4);
